...
public class LoggingAspect {
	...
	@AfterThrowing(pointcut = "execution(* com.battle.dao.*Impl.*(..))", throwing = "exception")	
	public void logExceptionFromDAO(Exception exception) throws Exception {
		log(exception);
	}
	
	@AfterThrowing(pointcut = "execution(* com.battle.service.*Impl.*(..))", throwing = "exception")	
